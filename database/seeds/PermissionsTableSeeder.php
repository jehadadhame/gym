...
class PermissionsTableSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    $permissions = [
      ...
      [
        'name' => 'view-male-members',
        'display_name' => 'View male members',
        'group_key' => 'Members',
      ],
      [
        'name' => 'view-female-members',
        'display_name' => 'View female members',
        'group_key' => 'Members',
      ],
      [
        'name' => 'view-member',
      ...
      [
        'name' => 'edit-product',
        'display_name' => 'Edit product details',
        'group_key' => 'products',
      ],
      [
        'name' => 'delete-product',
      ...
      [
        'name' => 'edit-purchase',
        'display_name' => 'Edit purchase details',
        'group_key' => 'Purchases',
      ],
      [
        'name' => 'renew-purchase',
        'display_name' => 'Renew purchase',
        'group_key' => 'Purchases',
      ],
      [
        'name' => 'view-purchase',
        'display_name' => 'View purchase details',
        'group_key' => 'Purchases',
      ],
      [
        'name' => 'cancel-purchase',
        'display_name' => 'Cancel purchase',
        'group_key' => 'Purchases',
      ],
      [
        'name' => 'delete-purchase',
        'display_name' => 'Delete Purchases',
        'group_key' => 'Purchases',
      ],
      [
        'name' => 'change-purchase',
        'display_name' => 'Upgrade or downgrade a purchase',
        'group_key' => 'Purchases',
      ],
