...
class InvoicesController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if ($invoice->subscription != null)
            return view('invoices.subscriptions.show', compact('invoice', 'settings'));
        elseif ($invoice->purchase != null)
            return view('invoices.purchases.show', compact('invoice', 'settings'));
        else
            dd([
                "invoice" => $invoice,
