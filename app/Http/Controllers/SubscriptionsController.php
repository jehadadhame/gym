...
class SubscriptionsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $subscriptions = Subscription::indexQuery(
            $request->sort_field,
    ...
    {
        $expirings = Subscription::expiring(
            $request->sort_field,
            $request->sort_direction,
            $request->drp_start,
            $request->drp_end,
    ...
    {
        $allExpired = Subscription::expired(
            $request->sort_field,
            $request->sort_direction,
            $request->drp_start,
            $request->drp_end,
    ...
    public function expired_gallary(Request $request)
    {
        $allExpired = Subscription::expired($request->sort_field, $request->sort_direction, $request->drp_start, $request->drp_end)->search($request->input('search'))->paginate(109);
        $count = $allExpired->total();
        ...
        return view('subscriptions.expired_gallery', compact('allExpired', 'count', 'drp_placeholder'));
    }
