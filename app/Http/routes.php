...
Route::group(['prefix' => 'api', 'middleware' => ['jwt.auth']], function () {
    ...
    Route::get('members/{phoneNumber}', 'MembersController@showbyPhoneNumber');
...
Route::group(['prefix' => 'members', 'middleware' => ['auth']], function () {
    ...
    // Route::get('create-with-no-info', ['middleware' => ['permission:manage-gymie|manage-members|add-member'], 'uses' => 'MembersController@create-with-no-info']);
...
Route::group(['prefix' => 'plans', 'middleware' => ['auth']], function () {
    ...
    Route::get('/{id}/show', ['middleware' => ['permission:manage-gymie|manage-plans|view-plan'], 'uses' => 'PlansController@show']);
...
Route::group(['prefix' => 'products', 'middleware' => ['auth']], function () {
    Route::get('/', ['middleware' => ['permission:manage-gymie|manage-products|view-product'], 'uses' => 'ProductController@index']);
    Route::get('all', ['middleware' => ['permission:manage-gymie|manage-products|view-product'], 'uses' => 'ProductController@index']);
    Route::get('/{id}/show', ['middleware' => ['permission:manage-gymie|manage-products|view-product'], 'uses' => 'ProductController@show']);
    Route::get('create', ['middleware' => ['permission:manage-gymie|manage-products|add-product'], 'uses' => 'ProductController@create']);
    Route::post('/', ['middleware' => ['permission:manage-gymie|manage-products|add-product'], 'uses' => 'ProductController@store']);
    Route::get('{id}/edit', ['middleware' => ['permission:manage-gymie|manage-products|edit-product'], 'uses' => 'ProductController@edit']);
    Route::post('{id}/update', ['middleware' => ['permission:manage-gymie|manage-products|edit-product'], 'uses' => 'ProductController@update']);
    Route::post('{id}/archive', ['middleware' => ['permission:manage-gymie|manage-products|delete-product'], 'uses' => 'ProductController@archive']);
});
...
Route::group(['prefix' => 'subscriptions', 'middleware' => ['auth']], function () {
    ...
    Route::get('expired_gallary', ['middleware' => ['permission:manage-gymie|manage-subscriptions|view-subscription'], 'uses' => 'SubscriptionsController@expired_gallary']);
...
Route::group(['prefix' => 'purchases', 'middleware' => ['auth']], function () {
    Route::get('/', ['middleware' => ['permission:manage-gymie|manage-purchases|view-purchase'], 'uses' => 'PurchaseController@index']);
    Route::get('all', ['middleware' => ['permission:manage-gymie|manage-purchases|view-purchase'], 'uses' => 'PurchaseController@index']);
    Route::get('belt', ['middleware' => ['permission:manage-gymie|manage-purchases|view-purchase'], 'uses' => 'PurchaseController@belt']);
    Route::get('create', ['middleware' => ['permission:manage-gymie|manage-purchases|add-purchase'], 'uses' => 'PurchaseController@create']);
    Route::post('/', ['middleware' => ['permission:manage-gymie|manage-purchases|add-purchase'], 'uses' => 'PurchaseController@store']);
    Route::get('{id}/show', ['middleware' => ['permission:manage-gymie|manage-purchases|view-purchase'], 'uses' => 'PurchaseController@show']);
    Route::get('{id}/edit', ['middleware' => ['permission:manage-gymie|manage-purchases|edit-purchase'], 'uses' => 'PurchaseController@edit']);
    Route::get('{id}/change', ['middleware' => ['permission:manage-gymie|manage-purchases|change-purchase'], 'uses' => 'PurchaseController@change']);
    Route::post('{id}/update', ['middleware' => ['permission:manage-gymie|manage-purchases|edit-purchase'], 'uses' => 'PurchaseController@update']);
    Route::post('{id}/delete', ['middleware' => ['permission:manage-gymie|manage-purchases|delete-purchase'], 'uses' => 'PurchaseController@delete']);
});
