...
<div class="rightside bg-grey-100">
    ...
    <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
        ...
        <h1 class="page-title no-line-height">الاشتراكات التي ستنتهي قريباً
            <small>تفاصيل الاشتراكات التي ستنتهي قريباً</small>
        </h1>
                        ...
                        @else
                            <div class="table-responsive">
                                <table id="subscriptions" class="table table-bordered table-striped" dir="rtl">
                                    ...
                                    <tbody>
                                        @foreach ($expirings as $subscription)
                                            <tr>
                                                <td>
                            ...
                            <div class="row margin-top-20">
                                <div class="col-xs-6">
                                    <div class="gymie_paging_info color-text-secondary">
                                        عرض الصفحة {{ $expirings->currentPage() }} من {{ $expirings->lastPage() }}
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <div class="gymie_paging pull-left">
                                        {!! str_replace('/?', '?', $expirings->appends(Input::all())->render()) !!}
                                    </div>
                                </div>
                            </div>
                        @endif
