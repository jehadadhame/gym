...
<div class="rightside bg-grey-100">
    ...
    <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
        ...
        <h1 class="page-title no-line-height">الاشتراكات المنتهية
            <small>تفاصيل الاشتراكات المنتهية في الصالة</small>
        </h1>
        @permission(['manage-gymie', 'pagehead-stats'])
        <h1 class="font-size-30 text-right color-error-text animated fadeInDown total-count pull-right"><span
                            ...
                            <div class="row margin-top-20">
                                ...
                                <div class="col-xs-6">
                                    <div class="gymie_paging pull-left">
                                        {!! str_replace('/?', '?', $allExpired->appends(Input::all())->render()) !!}
                                    </div>
                                </div>
                            </div>
                        @endif
